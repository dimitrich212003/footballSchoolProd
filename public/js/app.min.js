(() => {
  ...
  var F = {
    ...
    updateSlides: function () {
        ...
        if (
          ...
          if ("auto" === s.slidesPerView) {
            ...
            if (
              ...
              A = e.isHorizontal() ? C(r, "width", !0) : C(r, "height", !0);
            else {
              const e = t(n, "width"),
                s = t(n, "padding-left"),
                i = t(n, "padding-right"),
      ...
      if (
        ...
        P && e.grid.updateWrapperSize(A, p),
        !s.centeredSlides)
      ) {
        const t = [];
      ...
      if (
        ...
        w(i, "--swiper-centered-offset-before", -p[0] + "px"),
          w(
            i,
        ...
        (r = parseInt(
          ...
          t.centeredSlides
            ? n < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (n = e.getSlideIndex(
                  S(s, `${o}[data-swiper-slide-index="${r}"]`)[0]
                )),
                h(() => {
                  e.slideTo(n);
                }))
  ...
  var G = {
    ...
    loopFix: function (e) {
      ...
      const P = w ? Math.ceil(d.length / h.grid.rows) : d.length,
        A = (w ? d[n].column : n) + (f && void 0 === r ? -m / 2 + 0.5 : 0);
      if (A < v) {
        O = Math.max(v - A, g);
  ...
  function V(e) {
    ...
    const y = w && t.allowTouchMove && n.touchStartPreventDefault;
  ...
  function U(e) {
    ...
    for (
      ...
      void 0 !== l[e + t]
        ? (m || (p >= l[e] && p < l[e + t])) && ((g = e), (v = l[e + t] - l[e]))
        : (m || p >= l[e]) &&
    ...
    if (u > n.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (b >= n.longSwipesRatio
          ? t.slideTo(n.rewind && t.isEnd ? w : g + S)
          : t.slideTo(g)),
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const u = a.direction && a.direction !== i.direction,
            ...
            h = i.loop;
          u && s && e.changeDirection(), v(e.params, a);
  ...
  class re {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = O(S(t, `.${s.slideClass}, swiper-slide`)[0]);
      return O(e) - i;
    }
  ...
  function oe(e) {
    let t,
      s,
      { swiper: i, extendParams: r, on: n, emit: o, params: a } = e;
    ...
    let l,
      ...
      w = a && a.autoplay ? a.autoplay.delay : 3e3,
      y = new Date().getTime();
    function b(e) {
      i &&
        !i.destroyed &&
        ...
        (i.wrapperEl.removeEventListener("transitionend", b), g || C());
    }
    const S = () => {
      ...
      O = (e, s) => {
        ...
        if (((i.autoplay.paused = !0), s))
          return f && (l = i.params.autoplay.delay), (f = !1), void r();
      ...
      P = () => {
        if (i.destroyed || !i.autoplay.running) return;
        const e = c();
        "hidden" === e.visibilityState && ((m = !0), O(!0)),
          "visible" === e.visibilityState && C();
      },
      A = (e) => {
        "mouse" === e.pointerType &&
          ((m = !0), (g = !0), i.animating || i.autoplay.paused || O(!0));
      },
      L = (e) => {
    ...
    n("init", () => {
      ...
      n("_freeModeNoMomentumRelease", () => {
        i.params.autoplay.disableOnInteraction ? x() : O(!0, !0);
      }),
      n("beforeTransitionStart", (e, t, s) => {
        !i.destroyed &&
          i.autoplay.running &&
          (s || !i.params.autoplay.disableOnInteraction ? O(!0, !0) : x());
      }),
      n("sliderFirstMove", () => {
        !i.destroyed &&
          i.autoplay.running &&
      ...
      Object.assign(i.autoplay, { start: T, stop: x, pause: O, resume: C });
  }
  function ae(e, t) {
    const s = b(t);
    return (
    ...
    !(function (e) {
      ...
      setTranslate: () => {
        ...
        for (let e = 0, s = i.length; e < s; e += 1) {
          const s = i[e],
            a = r[e],
            u = (l - s.swiperSlideOffset - a / 2) / a,
            p =
              "function" == typeof n.modifier ? n.modifier(u) : u * n.modifier;
          let h = o ? d * p : 0,
            f = o ? 0 : d * p,
            m = -c * Math.abs(p),
            g = n.stretch;
          ...
          const b = `translate3d(${w}px,${v}px,${m}px)  rotateX(${f}deg) rotateY(${h}deg) scale(${y})`;
          if (
            ((ae(0, s).style.transform = b),
            ...
            e || (e = le("coverflow", s, o ? "left" : "top")),
              t || (t = le("coverflow", s, o ? "right" : "bottom")),
  ...
  var me;
  const ge = (e) => ((e = e.toLowerCase()), (t) => fe(t) === e),
    ve = (e) => (t) => typeof t === e,
    { isArray: we } = Array,
    ye = ve("undefined");
  const be = ge("ArrayBuffer");
  const Se = ve("string"),
    Ee = ve("function"),
    Te = ve("number"),
    xe = (e) => null !== e && "object" == typeof e,
    Oe = (e) => {
    ...
    Ae = ge("Blob"),
    Le = ge("FileList"),
    Me = ge("URLSearchParams");
  function _e(e, t, { allOwnKeys: s = !1 } = {}) {
    if (null == e) return;
    let i, r;
    if (("object" != typeof e && (e = [e]), we(e)))
      ...
      const r = s ? Object.getOwnPropertyNames(e) : Object.keys(e),
        n = r.length;
      let o;
      for (i = 0; i < n; i++) (o = r[i]), t.call(null, e[o], o, e);
    }
  }
  function ke(e, t) {
    t = t.toLowerCase();
    ...
    let i,
      r = s.length;
    for (; r-- > 0; ) if (((i = s[r]), t === i.toLowerCase())) return i;
    return null;
  }
  const Ie =
    ...
    Re = (e) => !ye(e) && e !== Ie;
  const De =
    ((Ne = "undefined" != typeof Uint8Array && he(Uint8Array)),
    (e) => Ne && e instanceof Ne);
  var Ne;
  const ze = ge("HTMLFormElement"),
    Fe = (
      ({ hasOwnProperty: e }) =>
      (t, s) =>
        e.call(t, s)
    ...
    Ge = "0123456789",
    $e = { DIGIT: Ge, ALPHA: qe, ALPHA_DIGIT: qe + qe.toUpperCase() + Ge };
  const Ve = ge("AsyncFunction"),
    He = {
      isArray: we,
      isArrayBuffer: be,
      isBuffer: function (e) {
      ...
      freezeMethods: (e) => {
        Be(e, (t, s) => {
          if (Ee(e) && -1 !== ["arguments", "caller", "callee"].indexOf(s))
            return !1;
          const i = e[s];
          Ee(i) &&
            ((t.enumerable = !1),
      ...
      toObjectSet: (e, t) => {
        ...
        return we(e) ? i(e) : i(String(e).split(t)), s;
      },
      toCamelCase: (e) =>
      ...
      isContextDefined: Re,
      ALPHABET: $e,
      generateString: (e = 16, t = $e.ALPHA_DIGIT) => {
        let s = "";
        const { length: i } = t;
      ...
      isAsyncFn: Ve,
      isThenable: (e) => e && (xe(e) || Ee(e)) && Ee(e.then) && Ee(e.catch),
    };
  ...
  [
    ...
    Object.defineProperties(Ue, Xe),
    Object.defineProperty(We, "isAxiosError", { value: !0 }),
    (Ue.from = (e, t, s, i, r, n) => {
      const o = Object.create(We);
      return (
        He.toFlatObject(
          e,
          o,
  ...
  function Qe(e, t, s) {
    return e
      ? e
          .concat(t)
          .map(function (e, t) {
            return (e = Je(e)), !s && t ? "[" + e + "]" : e;
          })
          .join(s ? "." : "")
      : t;
  }
  const Ze = He.toFlatObject(He, {}, null, function (e) {
    return /^is[A-Z]/.test(e);
  });
  const et = function (e, t, s) {
    if (!He.isObject(e)) throw new TypeError("target must be an object");
    t = t || new FormData();
    const i = (s = He.toFlatObject(
        s,
    ...
    function d(e, s, r) {
      ...
      if (e && !r && "object" == typeof e)
        if (He.endsWith(s, "{}"))
          ...
          (He.isArray(e) &&
            (function (e) {
              return He.isArray(e) && !e.some(Ke);
            })(e)) ||
          ((He.isFileList(e) || He.endsWith(s, "[]")) && (a = He.toArray(e)))
        )
          return (
            (s = Je(s)),
            a.forEach(function (e, i) {
              !He.isUndefined(e) &&
                null !== e &&
                t.append(
                  !0 === o ? Qe([s], i, n) : null === o ? s : s + "[]",
                  l(e)
                );
            }),
            !1
          );
      return !!Ke(e) || (t.append(Qe(r, s, n), l(e)), !1);
    }
    const c = [],
      u = Object.assign(Ze, {
        defaultVisitor: d,
    ...
    return (
      (function e(s, i) {
        if (!He.isUndefined(s)) {
          ...
          c.push(s),
            He.forEach(s, function (s, n) {
              !0 ===
                (!(He.isUndefined(s) || null === s) &&
                  r.call(t, s, He.isString(n) ? n.trim() : n, i, u)) &&
                e(s, i ? i.concat(n) : [n]);
            }),
            c.pop();
        }
  ...
  const at = class {
    ...
    ut =
      ((pt = "undefined" != typeof navigator && navigator.product),
      ct && ["ReactNative", "NativeScript", "NS"].indexOf(pt) < 0);
  var pt;
  const ht =
  ...
  const mt = function (e) {
    function t(e, s, i, r) {
      ...
      const o = Number.isFinite(+n),
        a = r >= e.length;
      if (((n = !n && He.isArray(i) ? i.length : n), a))
        return He.hasOwnProp(i, n) ? (i[n] = [i[n], s]) : (i[n] = s), !o;
      (i[n] && He.isObject(i[n])) || (i[n] = []);
      return (
        t(e, s, i[n], r) &&
          He.isArray(i[n]) &&
          (i[n] = (function (e) {
  ...
  const gt = {
    ...
    transformRequest: [
      function (e, t) {
        ...
        if (He.isFormData(e)) return i ? JSON.stringify(mt(e)) : e;
        if (
          He.isArrayBuffer(e) ||
          He.isBuffer(e) ||
          He.isStream(e) ||
        ...
        if (r) {
                ...
                Object.assign(
                  {
                    visitor: function (e, t, s, i) {
                      return ft.isNode && He.isBuffer(e)
          ...
          if ((n = He.isFileList(e)) || s.indexOf("multipart/form-data") > -1) {
    ...
    transformResponse: [
      function (e) {
        ...
        if (e && He.isString(e) && ((s && !this.responseType) || i)) {
  ...
  function St(e) {
    return !1 === e || null == e ? e : He.isArray(e) ? e.map(St) : String(e);
  }
  function Et(e, t, s, i, r) {
    return He.isFunction(i)
      ? i.call(this, t, s)
      : (r && (t = s),
        He.isString(t)
          ? He.isString(i)
  ...
  class Tt {
    ...
    set(e, t, s) {
      ...
      function r(e, t, s) {
        ...
        const n = He.findKey(i, r);
        (!n || void 0 === i[n] || !0 === s || (void 0 === s && !1 !== i[n])) &&
          (i[n || t] = St(e));
      }
      const n = (e, t) => He.forEach(e, (e, s) => r(e, s, t));
      return (
    ...
    get(e, t) {
      if ((e = bt(e))) {
        ...
        if (s) {
          ...
          if (He.isFunction(t)) return t.call(this, e, s);
    ...
    has(e, t) {
      if ((e = bt(e))) {
        const s = He.findKey(this, e);
        return !(!s || void 0 === this[s] || (t && !Et(0, this[s], s, t)));
      }
      return !1;
    }
    delete(e, t) {
      ...
      function r(e) {
        if ((e = bt(e))) {
          const r = He.findKey(s, e);
          !r || (t && !Et(0, s[r], r, t)) || (delete s[r], (i = !0));
        }
      }
      return He.isArray(e) ? e.forEach(r) : r(e), i;
    }
    clear(e) {
      ...
      for (; s--; ) {
        const r = t[s];
        (e && !Et(0, this[r], r, e, !0)) || (delete this[r], (i = !0));
      }
      return i;
    }
    normalize(e) {
      ...
      return (
        He.forEach(this, (i, r) => {
          const n = He.findKey(s, r);
          if (n) return (t[n] = St(i)), void delete t[r];
          const o = e
            ? (function (e) {
                return e
                  .trim()
    ...
    static accessor(e) {
      ...
      function i(e) {
        ...
        t[i] ||
          (!(function (e, t) {
            const s = He.toCamelCase(" " + t);
            ["get", "set", "has"].forEach((i) => {
              Object.defineProperty(e, i + s, {
                value: function (e, s, r) {
                  return this[i].call(this, t, e, s, r);
                },
                configurable: !0,
              });
            });
  ...
  Tt.accessor([
    ...
    He.reduceDescriptors(Tt.prototype, ({ value: e }, t) => {
  ...
  function Ot(e, t) {
    ...
    return (
      He.forEach(e, function (e) {
        n = e.call(s, n, r.normalize(), t ? t.status : void 0);
      }),
      r.normalize(),
      n
    );
  ...
  function Pt(e, t, s) {
    Ye.call(this, null == e ? "canceled" : e, Ye.ERR_CANCELED, t, s),
      (this.name = "CanceledError");
  }
  He.inherits(Pt, Ye, { __CANCEL__: !0 });
  const At = Pt;
  const Lt = ft.hasStandardBrowserEnv
    ? {
        write(e, t, s, i, r, n) {
          const o = [e + "=" + encodeURIComponent(t)];
          He.isNumber(s) && o.push("expires=" + new Date(s).toGMTString()),
            He.isString(i) && o.push("path=" + i),
            He.isString(r) && o.push("domain=" + r),
            !0 === n && o.push("secure"),
  ...
  const _t = ft.hasStandardBrowserEnv
    ? (function () {
  ...
  function It(e, t) {
    ...
    return (r) => {
      ...
      const d = {
        ...
        bytes: a,
        rate: l || void 0,
        estimated: l && o && n <= o ? (o - n) / l : void 0,
        event: r,
      };
    ...
    xhr:
      ...
      function (e) {
        return new Promise(function (t, s) {
          let i = e.data;
          const r = xt.from(e.headers).normalize();
          let n,
            o,
          ...
          if (e.auth) {
            const t = e.auth.username || "",
              s = e.auth.password
                ...
                : "";
            r.set("Authorization", "Basic " + btoa(t + ":" + s));
          }
          const u = Mt(e.baseURL, e.url);
          function p() {
            if (!c) return;
            const i = xt.from(
          ...
          if (
            (c.open(
              ...
              ot(u, e.params, e.paramsSerializer),
              !0
            ),
            (c.timeout = e.timeout),
            "onloadend" in c
            ...
            (c.onabort = function () {
              c &&
                (s(new Ye("Request aborted", Ye.ECONNABORTED, e, c)),
                (c = null));
            }),
            (c.onerror = function () {
              s(new Ye("Network Error", Ye.ERR_NETWORK, e, c)), (c = null);
            }),
            (c.ontimeout = function () {
              let t = e.timeout
                ? "timeout of " + e.timeout + "ms exceeded"
                : "timeout exceeded";
              const i = e.transitional || lt;
              e.timeoutErrorMessage && (t = e.timeoutErrorMessage),
                s(
                  new Ye(
                    t,
                    i.clarifyTimeoutError ? Ye.ETIMEDOUT : Ye.ECONNABORTED,
                    e,
                    c
                  )
                ),
            ...
            ft.hasStandardBrowserEnv &&
              (l && He.isFunction(l) && (l = l(e)), l || (!1 !== l && _t(u))))
          ) {
            const t =
              e.xsrfHeaderName && e.xsrfCookieName && Lt.read(e.xsrfCookieName);
          ...
          h && -1 === ft.protocols.indexOf(h)
            ? s(
                new Ye("Unsupported protocol " + h + ":", Ye.ERR_BAD_REQUEST, e)
              )
            : c.send(i || null);
        });
      },
  ...
  const Dt = (e) => `- ${e}`,
    Nt = (e) => He.isFunction(e) || null === e || !1 === e,
    zt = (e) => {
      e = He.isArray(e) ? e : [e];
      const { length: t } = e;
      let s, i;
      ...
      for (let n = 0; n < t; n++) {
        ...
        if (
          ((s = e[n]),
          (i = s),
          !Nt(s) && ((i = Rt[(t = String(s)).toLowerCase()]), void 0 === i))
        )
  ...
  function jt(e) {
    ...
    return zt(e.adapter || vt.adapter)(e).then(
      function (t) {
        return (
          Ft(e),
  ...
  const Bt = (e) => (e instanceof xt ? { ...e } : e);
  function qt(e, t) {
    t = t || {};
    const s = {};
    function i(e, t, s) {
      return He.isPlainObject(e) && He.isPlainObject(t)
        ? He.merge.call({ caseless: s }, e, t)
        : He.isPlainObject(t)
        ? He.merge({}, t)
        : He.isArray(t)
        ? t.slice()
    ...
    function a(s, r, n) {
      return n in t ? i(s, r) : n in e ? i(void 0, s) : void 0;
    }
    const l = {
      url: n,
      method: n,
      ...
      responseEncoding: o,
      validateStatus: a,
      headers: (e, t) => r(Bt(e), Bt(t), !0),
    };
    return (
      He.forEach(Object.keys(Object.assign({}, e, t)), function (i) {
        const n = l[i] || r,
          o = n(e[i], t[i], i);
        (He.isUndefined(o) && n !== a) || (s[i] = o);
      }),
      s
    );
  }
  ...
  class Wt {
    ...
    async request(e, t) {
      try {
        ...
        if (e instanceof Error) {
          ...
          e.stack
            ? s &&
              !String(e.stack).endsWith(s.replace(/^.+\n.+\n/, "")) &&
              (e.stack += "\n" + s)
            : (e.stack = s);
        }
        throw e;
    ...
    _request(e, t) {
      ...
      let n = r && He.merge(r.common, r[t.method]);
      r &&
        He.forEach(
      ...
      for (u = 0, c = l.length; u < c; ) d = d.then(l[u++], l[u++]);
      return d;
    }
    getUri(e) {
      return ot(
        Mt((e = qt(this.defaults, e)).baseURL, e.url),
        e.params,
        e.paramsSerializer
      );
    }
  ...
  He.forEach(["delete", "get", "head", "options"], function (e) {
    Wt.prototype[e] = function (t, s) {
      return this.request(
        qt(s || {}, { method: e, url: t, data: (s || {}).data })
      );
    };
  }),
  ...
  class Yt {
    constructor(e) {
      ...
      this.promise.then((e) => {
        ...
        e(function (e, i, r) {
          s.reason || ((s.reason = new At(e, i, r)), t(s.reason));
        });
    }
    throwIfRequested() {
  ...
  const Zt = (function e(t) {
    const s = new Xt(t),
      i = ue(Xt.prototype.request, s);
    return (
      He.extend(i, Xt.prototype, s, { allOwnKeys: !0 }),
      He.extend(i, s, null, { allOwnKeys: !0 }),
      (i.create = function (s) {
        return e(qt(t, s));
      }),
      i
  ...
  (Zt.Axios = Xt),
    ...
    (Zt.mergeConfig = qt),
    (Zt.AxiosHeaders = xt),
    (Zt.formToJSON = (e) => mt(He.isHTMLForm(e) ? new FormData(e) : e)),
    (Zt.getAdapter = zt),
    (Zt.HttpStatusCode = Qt),
    (Zt.default = Zt);
  const es = Zt,
    ts = document.querySelector(".header__burger"),
    ss = document.querySelector(".header__nav"),
    is = document.querySelector(".header__logo"),
    rs = document.querySelectorAll(".tel"),
    ns = document.querySelector(".main__contact-form"),
    os = document.querySelectorAll(".btnScroll"),
    as = document.getElementById("contact"),
    ls = document.querySelector(".main__contact-btn"),
    ds = (document.getElementById("price"), document.querySelector(".tel")),
    cs = new o(),
    us = document.createElement("img");
  (us.src = "././img/logoForBurger.png"),
    (us.className = "header__logo-img-active"),
    ts.addEventListener("click", () => {
      ts.classList.toggle("active"),
        ss.classList.toggle("active"),
        is.classList.toggle("active");
      const e = is.querySelector("a");
      document.body.classList.toggle("lock"),
        ss.classList.contains("active")
          ? e.insertBefore(us, e.firstChild)
          : e.removeChild(us);
    });
  const ps = document.querySelector(
      ".main__training-programm-text-action-hover"
    ),
    hs = document.querySelector(
      ".main__training-programm-text-action-hover-popup"
    );
  ps &&
    (ps.addEventListener("mouseover", () => {
      hs.classList.add("showActionPopup");
    }),
    ps.addEventListener("mouseout", () => {
      hs.classList.remove("showActionPopup");
    })),
    window.addEventListener("DOMContentLoaded", function () {
      [].forEach.call(rs, function (e) {
        let t;
        function s(e) {
          e.keyCode && (t = e.keyCode),
            this.selectionStart < 3 && e.preventDefault();
          let s = "+7 (___) ___ ____",
            i = 0,
            r = s.replace(/\D/g, ""),
            n = this.value.replace(/\D/g, ""),
            o = s.replace(/[_\d]/g, function (e) {
              return i < n.length ? n.charAt(i++) || r.charAt(i) : e;
            });
          (i = o.indexOf("_")),
            -1 != i && (i < 5 && (i = 3), (o = o.slice(0, i)));
          let a = s
        ...
        e.addEventListener("input", s, !1),
          ...
          17 === this.value.length && console.log("привет начальник");
      });
    }),
    os.forEach((e) => {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      const e = new URLSearchParams(window.location.search).get("scrollTo");
      if (e) {
      ...
      ds.addEventListener("input", (e) => {
        console.log(e.target.value.length),
          e.target.value.length >= 17
            ? ls.classList.add("activate_send")
            : ls.classList.remove("activate_send");
      }),
    ns &&
      ns.addEventListener("submit", function (e) {
        e.preventDefault();
        let t = "<b>Заявка с сайта!</b>\n";
        (t += `<b>Номер телефона: </b>${this.phone.value}`),
          es
            .post(
              "https://api.telegram.org/bot6954779819:AAGrSubT6WogUOEj01uGNpVDGv-XAqkiS6k/sendMessage",
              { chat_id: "-1001991035384", parse_mode: "HTML", text: t }
            )
            .then((e) => {
              ns.reset(),
                ls.classList.remove("activate_send"),
                cs.open("#myPopupSuccessfull");
            })
            .catch((e) => {
              cs.open("#myPopupError"), console.log(e);
            })
            .finally(() => {});
      });
  const fs = document.querySelectorAll(".gallery__chapter-title");
  fs &&
    fs.forEach((e) => {
      e.addEventListener("click", () => {
        ...
        e.classList.toggle("active"),
          ...
          "0" === window.getComputedStyle(t).opacity
  ...
  const ms = document.querySelectorAll(".goToPrice");
  ms &&
    ms.forEach((e) => {
      e.addEventListener("click", () => {
        window.location.href = "/?scrollTo=price";
      });
    }),
