(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".mySwiperMobile", {
    ...
    document.querySelector(".main__contact-form");
    ...
    if (goToPrice) goToPrice.forEach((link => {
    ...
    function init() {
        ...
        let placemark = new ymaps.Placemark([ 55.677176944132704, 37.61824045767209 ], {}, {
            iconLayout: "default#image",
            iconImageHref: "https://cdn-icons-png.flaticon.com/512/14438/14438151.png",
            iconImageSize: [ 50, 50 ],
